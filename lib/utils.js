...
module.exports = function (api) { // Export a function that takes api as argument
  ...
  async function printOrders (api, orders) { // Made async
    ...
    async function func (api, pair='') { // Made async
      ...
      return new Promise(async (resolve, reject) => { // Changed to async Promise
        try {
          ...
          await printOrders(api, toShow); // Await printOrders
  ...
  function trade (platform, operation) {
    async function func (api, q1, c1, p, c2, tif=constants.timeInForce.gtc, d=5) { // Made async
      return new Promise(async (resolve, reject) => { // Changed to async Promise
        try {
          q1 = parseFloat(q1);
          c1 = c1.toUpperCase();
          ...
          tif = tif.toUpperCase();
          d = parseFloat(d);
          const pair = await findPair(c1, c2); // Await findPair
          ...
          await printOrders(api, [order]); // Await printOrders
          resolve();
        } catch (err) {
          reject(err);
        }
  ...
  function mtrade (platform, operation) {
    async function func (api, q1, c1, p, c2, n, tif=constants.timeInForce.gtc, d=5) { // Made async
      return new Promise(async (resolve, reject) => { // Changed to async Promise
        try {
          q1 = parseFloat(q1);
          c1 = c1.toUpperCase();
          ...
          await printOrders(api, orders); // Await printOrders
          resolve();
        } catch (err) {
          reject(err);
        }
