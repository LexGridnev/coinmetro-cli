  ...
  constants.getPairs = async function() {
    if (dynamicPairs.length === 0) {
      try {
        ...
        dynamicPairs = [
          'BTCEUR', 'ETHEUR', 'QNTEUR', 'ENJEUR', 'XCMEUR', 'XLMEUR', 'LTCEUR', 'XRPEUR', 'LINKEUR', 'BATEUR', 'BCHEUR', 'XCMBTC', 'ETHBTC', 'LTCBTC', 'OMGEUR', 'XRPBTC', 'BTCGBP', 'ETHGBP', 'XRPGBP', 'BTCAUD', 'BTCEUR', 'BTCSEK', 'ETHAUD', 'ETHSEK', 'KDAEUR', 'PRQEUR', 'QNTEUR', 'USDCEUR', 'XTZEUR', 'BCHUSD', 'BTCUSD', 'ETHUSD', 'LTCUSD', 'PRQBETH', 'XRPUSD', 'XCMUSD'
        ];
      }
    }
    return dynamicPairs;
